...
const Home = () => {
  ...
  const PHONE = "(203) 223-1146";
  const EMAIL = "dominic73.perez@gmail.com";
  const MC_NUMBER = "1746838";
  const DOT_NUMBER = "4437384";
  const HOME_BASE = "285 MAPLEWOOD AVE APT 2C BRIDGEPORT, CT 06605";
  ...
  const handleDownload = (docName) => {
    ...
    fetch(filePath)
      ...
      .then(blob => {
        ...
        link.href = url;
        link.setAttribute('download', `${docName.replace(/\s+/g, '_')}_DOM.jpg`);
  ...
  const handleUnlock = (e) => {
    e.preventDefault();
    if (accessCode.toUpperCase() === 'DOM2026') {
      setIsUnlocked(true); 
      setShowModal(false); 
      setError('');
    } else { 
      setError('Invalid Code. Try "DOM2026"'); 
    }
  };
  ...
  const handleQuoteRequest = (e) => {
    ...
    const subject = encodeURIComponent(`Quote Request: ${quoteOrigin} to ${quoteDest} - BUEN0 DIAS ENTERPRISES LLC`);
    const body = encodeURIComponent(
      `Hi Andre,\n\nI am reaching out to request a quote for a load moving from ${quoteOrigin} to ${quoteDest}.\n\nEquipment Required: 26ft Box Truck\nCarrier: BUEN0 DIAS ENTERPRISES LLC (MC# ${MC_NUMBER})\n\nPlease let me know your availability and rate for this lane.\n\nBest regards,`
    );
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up z-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-none tracking-tight text-gray-900">
              <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-red-400">BUEN0 DIAS </span><br /> ENTERPRISES LLC
            </h1>
          ...
          <div className="relative w-full h-full animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            <div className="clip-trap relative z-10 bg-gray-800 aspect-[4/5] shadow-2xl group overflow-hidden">
              <img 
                src={heroTruck} 
                alt="BUEN0 DIAS ENTERPRISES LLC 26ft International Box Truck" 
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
           {/* Image Side */}
            <div className="relative group hover-lift">
              ...
              <img 
                src={driverImg} 
                alt="Dominic Perez - Owner Operator" 
              ...
              <div className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-md px-6 py-4 border-l-4 border-red-600 shadow-lg">
                <p className="font-black text-xl uppercase text-white">Dominic Perez</p>
           ...
           <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed border-l-4 border-red-200 pl-4">
                "I operate under my own authority to kill the anxiety brokers feel when they hang up the phone. When you book BUEN0 DIAS ENTERPRISES LLC, you aren't talking to a dispatcher—you're talking to the driver. 
                <br/><br/>
